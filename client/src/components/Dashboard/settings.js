...
const Settings = () => {
  ...
  return (
    <Container className='settings-page w-100 '>
      ...
      <hr />
      <h5 className='fw-bold pt-5 ml-4 '>
        Your Account
      </h5>
      <h5 className='fw-bold pt-4 ml-4 '>
        Change Your Account Password
      </h5>
      <Row>
        <Col lg={2} xs={7}>
          <h6 className='pt-4 ml-5'>
            Notifications
          </h6>
        </Col>
        <Col lg={4} xs={3} className='pt-4'>
          <MDBSwitch id='flexSwitchCheckDefault'
            onClick={toggle} label={isOpen ? 'Off' : 'On'} />
        </Col>
