  ...
  return (
    <Container className="dashbord-container">
      <div style={{ width: isOpen ? "250px" : "50px " }}>
        <nav
          className={isOpen ? "dashbord-nav-menu active" : "dashbord-nav-menu"}
        >
          <ul className="dashbord-nav-menu-items">
            <li
              style={{ marginLeft: isOpen ? "-30px" : "0px" }}
              className="dashbord-navbar-toggle"
              onClick={toggle}
            >
              <Link to="#" className="menu-bars">
                <FaIcons.FaBars color="gray" />
              </Link>
            </li>
            <li
              style={{ marginLeft: isOpen ? "-20px" : "0px" }}
              className="dashbord-Logo"
            >
              <img
                style={{
