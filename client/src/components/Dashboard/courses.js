...
const courses = () => {
  ...
  return (
    <div className='courses-page row w-100 justify-content-center'>

      <h1 className='dashboard-header col-5  fw-bold pt-5'>courses </h1> 
      <div className=' col-4 mt-3 w-100 '>
    ...
    <Row className='mt-5'>
      ...
      <Col lg={6} xs={11} className="m-4">
       <div className='english row w-100 float-right'>
        ...
        <div className='youtube' onClick={()=> window.open("https://youtube.com", "_blank")} href="">
          <BsIcons.BsYoutube/>
        </div>
      ...
      <Col lg={4} xs={10} className="m-4" >
        <div className='notes float-right'>
          ...
          <ul>
            ...
            <li className=' p-1'>
            Try To Equal The Effort With All Courses
            </li>
            <li className=' p-1'>
    ...
    <Row className='justify-content-center'>
      <Col lg={4} xs={10} className="m-5 float-right" >
        <div className='mathematics row w-100 float-right'>
          ...
          <Col className='p-4'>
          <h1 className='math-head fw-bold'>
          Mathematics
          </h1>
          <p>
            15 Lessons
      ...
      <Col lg={4} xs={10} className="m-5 float-right" >
        <div className='science row w-100 float-right'>
          ...
          <Col className='p-4'>
          <h1 className='science-head fw-bold'>
           Science
          </h1>
          <p>
            10 Lessons
