      ...
      <div className='welc-container col-7  justify-content-center'>                        
        ...
        <span>The New Dawn School For Online Education</span> 
         ...
         <p className='home-par'>
            The Mission of The New Dawn School for Children is to empower our children to achieve their greatest potential both as students and as
    ...
    <div className='cards row w-100 justify-content-center'>
      ...
      <div className='all-cards  card-1  '>
        <div className='card-content'>
         ...
         <p className='card-p'>
           grades k-5
            young minds are like newly formed galaxies
            full of energy, expansive & curious.
            poised & ready to stretch out and make
            their mark in the universe. at new dawn
            we believe that every child is full of brilliance
            and potential. at new dawn elementary 
      ...
      <div className=' all-cards card-2  '>
        <div className='card-content'>
         ...
         <p className='card-p'>
          Grades 6-8 Here at new dawn Academy we
            envision every student becoming a world
            -class scientist, technologist, engineer or
            mathematician. We encourage students to
            become critical thinkers & to explore
            and experiment with their talents
      ...
      <div className='all-cards card-3 '>
        <div className='card-content'>
           ...
           <p className='card-p'>
           Grades 9-12 Here at new dawn Academy we 
            envision every student becoming a world
            -class scientist, technologist, engineer or 
            mathematician. We encourage students to
            become critical thinkers & to explore
...
<div className='info-cards  '>
   ...
   <div class=" card-info-content ">
     ...
     What Is School Of New Dawn
     </h1>
     <br></br>
     <br></br>
     <p className='font-weight-normal '>
       We are a network of professionals with passion towards
        learning, equipped with our philosophy in learning as a
        whole through delivering education, building character
        and equipping tomorrow's leaders with the required skills
        to create a better world through contributing to creating a
        healthier student with a stable personality...
     </p>
   </div>
...
<div className='info-cards '>
   ...
   <div class="card-info-content card-info-content2  ">
     ...
     <p className='font-weight-normal '>
      ...
      platforms are offering free access to their services, including platforms like BYJU’S, a Bangalore-based educational technology and online tutoring firm founded in 2011, which is now the world’s most highly valued tech company. Since announcing free live classes on its Think and Learn app, 
      BYJU’s has seen a 200% increase in the number of new students using itsproduct, according to Mrinal Mohit, the company's Chief Operating Officer.
     </p>
